...
(Gravity mechanism: manually hang a weight in the air, attach a generator to the other end; weight slowly falls, generator spins, electricity comes out.) Gravity-based mechanisms are apparently very inefficient. I saw a calculation that shows a 100kg weight falling 10 meters generates the energy equivalent of a AA battery -- so not super great. I don't feel like hoisting a couple tons of rock into the air just to charge my laptop.
...
Craigslist is a great source of panels, however. I found these for an ask of $90:
...
So far, we're up to `9 + 7 + 5 + 5`, conservatively.  That's 26 Amps total, and 52 (fifty-two!) of those solar panels.  Even if we assume perfect efficiency and a desert locale, that's 31 panels and $1395...assuming it's possible to find 15 such cragislist deals. Not great, even at minimal power requirements.
